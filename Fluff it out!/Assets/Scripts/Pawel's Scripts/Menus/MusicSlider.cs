...
/// <summary>
/// This script is used to control the slider for the music volume
/// </summary>
public class MusicSlider : MonoBehaviour {
    ...
    /// <summary>
    /// when the menu right button is pressed,the value of the music slider is increased by 1
    /// </summary>
    void IncreaseVolume() {
    ...
    /// <summary>
    /// when the menu left button is pressed, the value of the music slider is decreased by 1
    /// </summary>
    void DecreaseVolume() {
        slider.GetComponent<Slider>().value -= 1;
    }
